...
const PortalDonCor = () => {
  ...
  const renderInclusao = () => <div style={{ display:'grid', gridTemplateColumns:'2fr 0.95fr', gap:22 }}><div style={{ display:'grid', gap:22 }}><section style={{ ...card, padding:24 }}><h3 style={{ color:theme.primary, margin:'0 0 14px', fontSize:'1.25rem', display:'flex', alignItems:'center', gap:10 }}><Building2 size={20}/>Dados do Contrato</h3><div style={{ borderTop:`1px solid ${theme.border}`, paddingTop:18, display:'grid', gridTemplateColumns:'1fr 1fr', gap:18 }}><div><label style={fieldLabel}>Operadora</label><select style={selectStyle}><option>Selecione a Operadora</option><option>Assim Saúde</option><option>Amil</option><option>SulAmérica</option></select></div><div><label style={fieldLabel}>Plano</label><div style={{ display:'flex', gap:18, marginTop:12 }}><label style={checkboxRow}><input type="checkbox" />Saúde</label><label style={checkboxRow}><input type="checkbox" />Dental</label></div></div></div></section><section style={{ ...card, padding:24 }}><h3 style={{ color:theme.primary, margin:'0 0 14px', fontSize:'1.25rem', display:'flex', alignItems:'center', gap:10 }}><UserPlus size={20}/>Dados do Beneficiário</h3><div style={{ borderTop:`1px solid ${theme.border}`, paddingTop:18, display:'grid', gridTemplateColumns:'1fr 1fr', gap:18 }}><div style={{ gridColumn:'1 / -1' }}><label style={fieldLabel}>Nome Completo</label><Input placeholder="Ex: João da Silva" /></div><div><label style={fieldLabel}>CPF</label><Input placeholder="000.000.000-00" /></div><div><label style={fieldLabel}>Estado Civil</label><select style={selectStyle}><option>Selecione</option><option>Solteiro(a)</option><option>Casado(a)</option></select></div><div><label style={fieldLabel}>E-mail</label><Input placeholder="email@exemplo.com" /></div><div><label style={fieldLabel}>Telefone</label><Input placeholder="(11) 90000-0000" /></div></div></section></div><div style={{ display:'grid', gap:22, alignContent:'start' }}><section style={{ ...card, padding:24, background:'#eef4ff', border:'1px solid #bad3ff' }}><h3 style={{ color:theme.primary, margin:'0 0 18px', fontSize:'1.2rem', display:'flex', alignItems:'center', gap:10 }}><RefreshCw size={20}/>Tipo de Inclusão</h3><div style={{ display:'grid', gap:14 }}><label style={radioCard}><input type="radio" name="tipo-inclusao"/><div><strong>No vencimento</strong><div style={{ color:theme.muted, marginTop:4 }}>Inclusão programada para a próxima fatura.</div></div></label><label style={{ ...radioCard, background:'#eef4ff' }}><input type="radio" name="tipo-inclusao"/><div><strong>Imediato</strong><div style={{ color:theme.muted, marginTop:6 }}><span style={{ background:'#fed7aa', color:'#9a3412', fontSize:'0.7rem', fontWeight:900, borderRadius:6, padding:'3px 7px' }}>ATENÇÃO</span></div><div style={{ color:theme.text, marginTop:8, fontSize:'0.84rem' }}>Sujeito a regras de pró-rata dependendo da operadora.</div></div></label></div></section><section style={{ ...card, padding:24 }}><h3 style={{ color:theme.primary, margin:'0 0 14px', fontSize:'1.2rem', display:'flex', alignItems:'center', gap:10 }}><Paperclip size={20}/>Anexos Necessários</h3><div style={{ borderTop:`1px solid ${theme.border}`, paddingTop:14, display:'grid', gap:12 }}>{['RG / CPF','Comprovante de Residência','CTPS / eSocial','Formulário Assinado'].map((doc) => <label key={doc} style={{ ...checkboxRow, border:`1px solid ${theme.border}`, padding:'12px 14px', borderRadius:10, justifyContent:'space-between' }}><span><input type="checkbox" style={{ marginRight:10 }}/>{doc}</span><UploadCloud size={18} color={theme.muted}/></label>)}</div></section></div></div>;

  const renderExclusao = () => <section style={{ ...card, padding:28 }}><div style={{ maxWidth:900 }}><div style={{ marginBottom:28 }}><label style={fieldLabel}>Operadora</label><select style={{ ...selectStyle, maxWidth:420 }}><option>Selecione a operadora</option><option>Assim Saúde</option><option>Amil</option></select></div><div style={{ borderTop:`1px solid ${theme.border}`, paddingTop:24, marginBottom:24 }}><h3 style={{ color:theme.primary, margin:'0 0 16px', fontSize:'1.25rem' }}>Seleção de Contrato</h3><div style={{ display:'flex', gap:32 }}><label style={checkboxRow}><input type="checkbox" />Dental</label><label style={checkboxRow}><input type="checkbox" />Saúde</label></div></div><div style={{ borderTop:`1px solid ${theme.border}`, paddingTop:24, marginBottom:24 }}><h3 style={{ color:theme.primary, margin:'0 0 16px', fontSize:'1.25rem' }}>Tipo de Exclusão</h3><div style={{ display:'grid', gap:14 }}><label style={checkboxRow}><input type="radio" name="tipo-exclusao"/> <span><strong>No vencimento</strong><div style={{ color:theme.muted, fontSize:'0.82rem', marginTop:4 }}>A exclusão ocorrerá na data de aniversário do contrato.</div></span></label><label style={checkboxRow}><input type="radio" name="tipo-exclusao"/> <span><strong>Imediato</strong><div style={{ color:theme.muted, fontSize:'0.82rem', marginTop:4 }}>A exclusão imediata pode estar sujeita a multas ou restrições contratuais.</div></span></label></div></div><div style={{ borderTop:`1px solid ${theme.border}`, paddingTop:24, marginBottom:24 }}><h3 style={{ color:theme.primary, margin:'0 0 16px', fontSize:'1.25rem' }}>Dados do Beneficiário</h3><div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:18 }}><div><label style={fieldLabel}>Nome Completo</label><Input placeholder="Nome do beneficiário" /></div><div><label style={fieldLabel}>CPF</label><Input placeholder="000.000.000-00" /></div></div></div><div style={{ borderTop:`1px solid ${theme.border}`, paddingTop:24 }}><h3 style={{ color:theme.primary, margin:'0 0 8px', fontSize:'1.25rem' }}>Anexos Necessários</h3><p style={{ color:theme.muted, margin:'0 0 16px', fontSize:'0.86rem' }}>Selecione os documentos que serão enviados para esta solicitação.</p><div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:14, marginBottom:20 }}>{['Termo de Rescisão','Formulário de Exclusão Assinado'].map((doc) => <label key={doc} style={{ ...checkboxRow, border:`1px solid ${theme.border}`, borderRadius:10, padding:'14px 16px' }}><input type="checkbox" />{doc}</label>)}</div>{uploadBox}</div><div style={{ borderTop:`1px solid ${theme.border}`, marginTop:28, paddingTop:20, display:'flex', justifyContent:'flex-end', gap:12 }}><Button variant="outline">Cancelar</Button><Button style={{ background:theme.primary, color:'#fff' }}>Enviar Solicitação</Button></div></div></section>;

  const renderAlteracao = () => <section style={{ ...card, padding:28 }}><h3 style={{ color:theme.primary, margin:'0 0 18px', fontSize:'1.35rem' }}>Solicitar Alteração</h3><div style={{ borderTop:`1px solid ${theme.border}`, paddingTop:24 }}><h4 style={{ margin:'0 0 14px', color:theme.text }}>1. Selecione o(s) Contrato(s)</h4><div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:16, marginBottom:28 }}><label style={{ ...radioCard, alignItems:'center' }}><input type="checkbox" defaultChecked/><div><strong>Saúde</strong><div style={{ color:theme.muted, fontSize:'0.82rem' }}>Apólice nº 987654321</div></div></label><label style={{ ...radioCard, alignItems:'center' }}><input type="checkbox"/><div><strong>Dental</strong><div style={{ color:theme.muted, fontSize:'0.82rem' }}>Apólice nº 123456789</div></div></label></div><h4 style={{ margin:'0 0 14px', color:theme.text }}>2. Tipo de Solicitação</h4><div style={{ display:'grid', gridTemplateColumns:'repeat(4, 1fr)', gap:14, marginBottom:28 }}>{['Alteração Cadastral','Upgrade','Downgrade','Outros'].map((tipo, index) => <label key={tipo} style={{ ...checkboxRow, border:`1px solid ${theme.border}`, borderRadius:10, padding:'14px 16px' }}><input type="checkbox" defaultChecked={index === 0}/>{tipo}</label>)}</div><h4 style={{ margin:'0 0 14px', color:theme.text }}>3. Detalhes da Alteração</h4><textarea placeholder="Descreva os dados que precisam ser alterados ou as especificações do upgrade/downgrade..." style={{ width:'100%', minHeight:110, border:`1px solid ${theme.border}`, borderRadius:10, padding:14, fontFamily:'inherit', fontSize:'0.92rem', marginBottom:28 }} /><h4 style={{ margin:'0 0 14px', color:theme.text }}>4. Anexos</h4>{uploadBox}<div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', border:`1px solid ${theme.border}`, borderRadius:10, padding:'12px 16px', marginTop:14 }}><div style={{ display:'flex', alignItems:'center', gap:10 }}><FileText size={20} color={theme.muted}/><div><strong style={{ color:theme.text }}>comprovante_residencia.pdf</strong><div style={{ color:theme.muted, fontSize:'0.75rem' }}>1.2 MB</div></div></div><button style={{ border:0, background:'transparent', color:'#dc2626', cursor:'pointer', fontWeight:900 }}>Remover</button></div><div style={{ borderTop:`1px solid ${theme.border}`, marginTop:28, paddingTop:20, display:'flex', justifyContent:'flex-end', gap:12 }}><Button variant="outline">Cancelar</Button><Button style={{ background:theme.primary, color:'#fff' }}>Enviar Solicitação</Button></div></div></section>;
